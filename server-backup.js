...
router.get("/webstore",function(req,res){
        ...
        if(err) {
            ...
            //res.render('/webstore.ejs', { data, customerOrderAtWebStore });
        }
    });
    })

router.get("/webstore-cart",function(req,res){
...
router.post("/webstore-add-to-cart",(function(req,res){
...
router.post("/send-web-order-to-database",(function(req,res){
...
router.get("/webstore-orders",function(req,res){
        res.render(__dirname + '/web-orders-get-new');
        console.log('success: web-orders-get-new .get');
});


router.get("/webstore-order-pick",function(req,res){
    var response = {};
...
router.post("/webstore-order-finalize", function(req, res) {
...
router.post("/send-store-reciept-to-database",(function(req,res){
