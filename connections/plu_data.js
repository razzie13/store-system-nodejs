...
const connection_plu_data = mongoose.createConnection(uri_plu_data, { useUnifiedTopology: true, useNewUrlParser: true }, function(err){
    if (!err){
...
const plu_data = connection_plu_data.model('store_plu_data', require('../schema-plu-data'));
