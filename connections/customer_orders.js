...
const connection_customer_orders = mongoose.createConnection(uri_customer_orders, { useUnifiedTopology: true, useNewUrlParser: true }, function(err){
    if (!err){
...
connection_customer_orders.model('checkout_and_online_orders', require('../schema-orders'));
