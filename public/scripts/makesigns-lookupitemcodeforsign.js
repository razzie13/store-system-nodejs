function lookUpItemCodeForSign()  {
    ...
    if (itemFound.itemDepartment == "Produce")  {
            ...
            console.log('you still need to find a way to add this to the sign');
        }
    ...
    for (i = 0; i < storeSignList.length; i++)  {
        ...
        signsCreated += 
        //"<div class='sign' id=" + [i] + "><h3>" + storeSignList[i].itemName + "</h3><br><h5>" + storeSignList[i].itemOrigin + "</h5>" + 
